...
* A measure of how close the top player is to being guaranteed a [lock-tie](http://www.j-archive.com/help.php#locktie) headed into Final Jeopardy! not taking daily doubles into account (calculated as `(top.score/2 - middle.score) / money.left` and bounded between 0 and 1)
* A measure of how close the top player is to being guaranteed a [crush](http://www.j-archive.com/help.php#crush) headed into Final Jeopardy! not taking daily doubles into account (calculated as `(top.score*2/3 - middle.score) / money.left` and bounded between 0 and 1)
* A measure of how close the top player is to being guaranteed the lead headed into Final Jeopardy! not taking daily doubles into account (calculated as `(top.score - middle.score) / money.left` and bounded between 0 and 1)
